/*
 ...
 Description : 	Modificar la función que calcula el promedio en la opción 4 del Menú,
...
float CalcularPromedio(int p[], int len);
...
int main(void)
{
	...
	do
	{
		...
		case 3:
			...
			break;
		case 4:
			respuestaCase4 = CalcularPromedio(edades, TAM);
